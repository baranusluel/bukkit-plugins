...
/*
 * This class has been taken from misson20000's
 * CBWrapper plugin.
 */
...
public class DummyPlayer implements Player {
    ...
    public DummyPlayer(String name, UUID uuid, Server server) {
		this.server = server;
		this.name = name;
		this.uuid = uuid;
    ...
    @Override public Location getLocation() { return loc; }
    @Override public Location getLocation(Location arg0) { return loc; }
    ...
    @Override public Location getBedSpawnLocation() { return loc; }
    @Override public Location getCompassTarget() { return loc; }
    @Override public String getDisplayName() {
    	return ChatColor.stripColor(Main.es.getPermissionsHandler().getPrefix(this).replace('&', '§') + name + Main.es.getPermissionsHandler().getSuffix(this).replace('&', '§') + "§r");
	}
	...
	@Override public double getEyeHeight(boolean arg0) { return 0; }
	@Override public Location getEyeLocation() { return loc; }
