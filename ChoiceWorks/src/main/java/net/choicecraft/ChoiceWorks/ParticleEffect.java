...
import net.choicecraft.ChoiceWorks.ReflectionUtilities.PackageType;
import net.choicecraft.ChoiceWorks.ReflectionUtilities.PacketType;
	...
	public static final class ParticleEffectPacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				packetConstructor = ReflectionUtilities.getConstructor(packetClass);
				getHandle = ReflectionUtilities.getMethod("CraftPlayer", PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
				playerConnection = ReflectionUtilities.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
				sendPacket = ReflectionUtilities.getMethod(playerConnection.getType(), "sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet"));
		...
		public void sendTo(Location center, Player player) throws PacketInstantiationException, PacketSendingException {
			if (packet == null) {
				try {
					...
					ReflectionUtilities.setValue(packet, true, "a", name);
					ReflectionUtilities.setValue(packet, true, "b", (float) center.getX());
					ReflectionUtilities.setValue(packet, true, "c", (float) center.getY());
					ReflectionUtilities.setValue(packet, true, "d", (float) center.getZ());
					ReflectionUtilities.setValue(packet, true, "e", offsetX);
					ReflectionUtilities.setValue(packet, true, "f", offsetY);
					ReflectionUtilities.setValue(packet, true, "g", offsetZ);
					ReflectionUtilities.setValue(packet, true, "h", speed);
					ReflectionUtilities.setValue(packet, true, "i", amount);
				} catch (Exception exception) {
