  ...
  implements Listener
{
  ...
  public void castSpell(int dura, Player player) {
    ...
    try {
      this.firework.playFirework(player.getWorld(), location, FireworkEffect.builder().withColor(Color.BLACK).withFade(Color.RED).with(FireworkEffect.Type.BURST).trail(false).flicker(true).build());
