...
public class PhysicsListener implements Listener {
	...
	public void onBlockPhysics(BlockPhysicsEvent e) {
		if (!(e.getBlock().isLiquid()
				...
				|| e.getBlock().getType() == Material.ENDER_PORTAL || e
				.getBlock().getType() == Material.SUGAR_CANE_BLOCK)) {
			return;
		}
		if (!PortalsManager.getPortals().containsKey(e.getBlock().getWorld())) {
			return;
		}

		for (Portal p : PortalsManager.getPortals().get(e.getBlock().getWorld())) {
